...
export class StudentRepository {
  ...
  async findOneByStudentId(studentId: number, centerId: number) {
    return await this.studentDAO
      ...
      .leftJoin('DLS.lessonRoom', 'DR')
      .addSelect(['DR.id', 'DR.name'])
      ...
      .addSelect(['SLS.id', 'SLS.sessionDate', 'SLS.startTime', 'SLS.endTime'])
      .leftJoin('SLS.lessonRoom', 'SR')
      .addSelect(['SR.id', 'SR.name'])
